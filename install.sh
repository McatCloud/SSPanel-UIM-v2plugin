...
pre_install_docker_compose(){
    ...
    read -p "(Default GitYuanJ@test.com):" cloudflare_email
    [ -z "${cloudflare_email}" ]  && cloudflare_email="GitYuanJ@test.com"
    echo
    echo "---------------------------"
    ...
    read -p "(image address (Default armeoun/v2_tlsws:go_pay):" docker_addresss
    [ -z "${docker_addresss}" ] && docker_addresss="armeoun/v2_tlsws:go_pay"
    echo
    echo "---------------------------"
